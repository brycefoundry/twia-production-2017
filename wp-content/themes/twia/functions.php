...
function twentysixteen_scripts() {
	...
	wp_enqueue_script( 'theme-plugins', get_stylesheet_directory_uri() . '/js/plugins.js', array(), filemtime( get_stylesheet_directory() . '/js/plugins.js' ) );
	wp_enqueue_script( 'theme-scripts', get_stylesheet_directory_uri() . '/js/functions.min.js', array(), filemtime( get_stylesheet_directory() . '/js/functions.min.js' ) );
	wp_enqueue_script( 'theme-maps', get_stylesheet_directory_uri() . '/js/google-maps.js', array(), filemtime( get_stylesheet_directory() . '/js/google-maps.js' ) );
...
function my_acf_google_map_api( $api ){
  $api['key'] = 'AIzaSyCnG90T7pofNVITm8Dlz7r6VUJntZN3uck';
  return $api;
} 
...
function rob_override_the_password_form( $form = '' ) {
    ...
    $form = '<form class="box" action="' . esc_url( site_url( 'wp-login.php?action=postpass', 'login_post' ) ) . '" method="post">
    ' . __( "<h4>Please login to view this page.</h4><br />
For password help: <br /><strong>Adjusters Email:</strong> <a href='mailto:claims@twia.org'>claims@twia.org</a>, <br /><strong>Agents Email:</strong> <a href='mailto:agentservices@twia.org'>agentservices@twia.org</a><br /> or call 800-788-8247" ) . '
    <hr><label for="' . $label . '">' . __( "Password:" ) . ' </label><input name="post_password" id="' . $label . '" type="password" size="20" maxlength="20" /><input type="submit" name="Submit" value="' . esc_attr__( "Submit" ) . '" />
    </form>
    ';
    return $form;
}

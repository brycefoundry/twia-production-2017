...
<div id="primary" class="content-area">
	<main id="main" class="site-main" role="main">
			...
			<section class="lg-masthead" id="home-section-1">
				<div class="inner">
					<div class="fifty-col left">
						...
						<?php else : ?>
							...
							global $post;
							$args = array( 'posts_per_page' => 1, 'tag' => 'home-feature' );
					...
					<div class="fifty-col right">
						...
						<?php if(get_field('quat_content')!=''): ?>
							<div class="secondary-feature two split">
						...
						<?php if(get_field('quat_content')!=''): ?>
						<div class="secondary-feature three split">
							<div class="content-container">
								
								
								<?php the_field('quat_content');?>
			...
			<?php if( have_rows('content_block') ):?>
				...
				<?php if($count==3): ?>
					...
					<section class="pane" id="home-section-<?php echo $count;?>" data-a="<?php echo strip_tags(get_field('number_amount_1')); ?>" data-b="<?php echo strip_tags(get_field('number_amount_2')); ?>" data-c="<?php echo strip_tags(get_field('number_amount_3')); ?>" data-d="<?php echo strip_tags(get_field('number_amount_4')); ?>">
				<?php else: ?>

				<section class="pane" id="home-section-<?php echo $count;?>">

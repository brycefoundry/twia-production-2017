...
define("DP_SOCIALTIMELINE_VER","1.8.8",false);//Current Version of this plugin
...
if(!isset($dpSocialTimeline['cache_data'])) {
	$dpSocialTimeline['cache_data'] = true;
					
	$sql = "ALTER TABLE $table_name_timelines ADD (cache_data text NULL);";
	$wpdb->query($sql);
	
	$sql = "ALTER TABLE $table_name_timelines ADD (cache_last_update INT(11) NULL);";
	$wpdb->query($sql);

	...
	<div style="clear:both;"></div>
 	...
 	<div id="dp_ui_content">
        ...
        <div class="wrapper no_margin">
            ...
            <h2><?php _e('Youtube API Key','dpSocialTimeline'); ?></h2>
            <div class="option option-select">
                <div class="option-inner">
                    <label class="titledesc"><?php _e('App Key:','dpSocialTimeline'); ?></label>
                    <div class="formcontainer">
                        <div class="forminp">
                            <input type='text' name='dpSocialTimeline_options[google_api_key]' value="<?php echo $dpSocialTimeline['google_api_key']?>"/>
                            <br>
                        </div>
                        <div class="desc"></div>
                    </div>
            ...
            <strong><?php _e('Instructions to get the Youtube API key','dpSocialTimeline'); ?></strong>
            <ol>
                ...
                <li>In the sidebar on the left, expand APIs & auth. Next, click APIs. In the list of APIs, make sure that the Youtube Data API shows a status of ON.</li>
                <li>In the sidebar on the left, select Credentials.</li>
                <li>Click Create new Key and select the browser key type</li>
            </ol>
        </div>
    </div>
	 <!--end of poststuff --> 

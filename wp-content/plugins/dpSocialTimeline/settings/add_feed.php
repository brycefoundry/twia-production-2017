...
?>
    <div class="postbox slidebox">
        ...
        <button type="button" class="handlediv button-link" aria-expanded="true"><span class="screen-reader-text"><?php _e('Show/Hide Feed', 'dpSocialTimeline'); ?></span><span class="toggle-indicator" aria-hidden="true"></span></button>
                                ...
                                <div class="formcontainer">
                                    <div class="forminp">
                                    	<select name="social_name[]" style="width:150px;" class="large-text dpSocialTimeline_social_name" id="dpSocialTimeline_social_name" onchange="changeSocialFeed(this);">
                                            ...
                                            <option value="twitter_search" <?php if($social_name == 'twitter_search') { echo 'selected="selected"'; }?>>Twitter Search</option>

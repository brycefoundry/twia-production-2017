                                ...
                                success: function(response){
                                        if ( typeof response.city != 'undefined' && response.city.length > 0 &&
                                             typeof response.country_code != 'undefined' && response.country_code.length > 0) {
                                                ...
                                                that.weather_options.q = response.city + region + "," + response.country_code;
                                        } else if ( typeof response.latitude != 'undefined' && typeof response.longitude != 'undefined' &&
                                                    response.latitude != '' && response.longitude != '' ) {
                                                that.weather_options.q = '';

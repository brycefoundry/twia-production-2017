<div class="cmb-container">
        <div class="row">
                <div class="small-3 columns">
                        <label><?php _e('Weather Service Provider', ASTERO_SLUG); ?></label>
                </div>
                <div class="small-9 columns end">
                        <div class="row cmb-row">
                                <div class="small-1 columns"><input id="service" type="radio" class="select-change" name="service" value="owm" <?php checked($service, 'owm'); ?>></div>
                                <div class="small-11 columns"><?php _e('Open Weather Map', ASTERO_SLUG); ?></div>
                        </div>
                        <div class="row cmb-row">
                                <div class="small-1 columns"><input id="service" type="radio" class="select-change" name="service" value="fc" <?php checked($service, 'fc'); ?>></div>
                                <div class="small-11 columns"><?php _e('Forecast.io (Supports Https)', ASTERO_SLUG); ?></div>
                        </div>
                </div>
        </div>
        <div class="row">
                ...
                <div class="small-9 columns end">
                        <div class="row cmb-row">
                                ...
                                <div class="small-11 columns"><?php _e('Html5 Geolocation with IP fallback', ASTERO_SLUG); ?></div>
                        </div>
                        <div class="row cmb-row">
        ...
        <div class="row<?php if( $location != 'city' ) echo ' js-hide'; ?>" data-check-field="location" data-check-value="location-city">
                <div class="small-3 columns">
                        <label><?php _e('Custom Location Name (Optional)', ASTERO_SLUG); ?></label>
                        <p class="description"><?php _e('Set the location title to any desired value', ASTERO_SLUG); ?></p>
                </div>
                <div class="small-9 columns end">
                        <input type="text" class="regular-text" name="heading" value="<?php echo $heading; ?>" /> 
                </div>
        </div>
        <div class="row">
                <div class="small-3 columns">
        ...
        <div class="row">
                ...
                <div class="small-9 columns end">
                        <select name="lang" class="css-select<?php if( $service != 'owm' ) echo ' js-hide'; ?>" data-check-field="service" data-check-value="service-owm">
                                <?php foreach ( $languages as $code => $l): ?>
                                <option value="<?php echo $code; ?>" <?php selected($lang, $code); ?>><?php echo $l; ?></option>
                                <?php endforeach; ?>
                        </select>
                        <select name="fc_lang" class="css-select<?php if( $service != 'fc' ) echo ' js-hide'; ?>" data-check-field="service" data-check-value="service-fc">
                                <?php foreach ( $fc_languages as $code => $l): ?>

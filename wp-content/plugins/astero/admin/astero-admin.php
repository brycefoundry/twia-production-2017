...
if (!function_exists('astero_save_meta'))
{
        function astero_save_meta( $post_id ){          
                ...
                $posts['lat'] = '';
                $posts['lon'] = '';
                if( $posts['service'] == 'fc' && $posts['location'] == 'city' ) {

                        $url = 'https://maps.googleapis.com/maps/api/geocode/json?address=' . urlencode($posts['city']);
